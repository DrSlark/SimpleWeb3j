...
import web3j.protocol.core.methods.request.ShhPost;
...
import web3j.protocol.core.methods.response.EthSubscribe;
...
import web3j.protocol.rx.JsonRpc2_0Rx;
import web3j.protocol.websocket.events.LogNotification;
import web3j.protocol.websocket.events.NewHeadsNotification;
import web3j.utils.Async;
...
public class JsonRpc2_0Web3j implements Web3j {
    ...
    @Override
    public Request<?, web3j.protocol.core.methods.response.ShhPost> shhPost(ShhPost shhPost) {
        return new Request<>(
                "shh_post",
                Arrays.asList(shhPost),
                web3jService,
                web3j.protocol.core.methods.response.ShhPost.class);
    }
    ...
    @Override
    public Flowable<web3j.protocol.core.methods.response.Transaction>
            transactionFlowable() {
